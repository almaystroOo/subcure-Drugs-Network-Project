...
<link rel="stylesheet" href="css/contact-us.css" media="screen">
 ...
 &nbsp;&nbsp; <button style="background-color:black;border-radius:50%;color:white;margin: 0 70px 30px  0;float:left;padding:15px;" onclick="window.location.href='add_pharmacy.php'">Add New </button><br>
    <br>
