  ...
  <?php include_once "header.php"; ?>
    <br>
         <section class="u-align-center u-clearfix u-section-1" id="sec-2aff" style="margin-top:70px">
            ...
            <center>
          &nbsp;&nbsp; <button style="background-color:black;border-radius:50%;color:white;margin: 0 70px 30px  0;padding:15px; margin-top:70px" onclick="window.location.href='drugs.php'">Add New </button><br>
            </center>
