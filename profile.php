...
<link rel="stylesheet" href="css/contact-us.css" media="screen">
 ...
 &nbsp;&nbsp; <button style="background-color:black;border-radius:50%;color:white;margin: 0 70px 30px  0;float:left;padding:15px;" onclick="window.location.href='drugs.php'">Add New </button><br>
    <br>
         <section class="u-align-center u-clearfix u-section-1" id="sec-2aff">
                ...
                <table class="u-table-entity u-table-entity-1">
                  ...
                  <thead class="u-black u-table-header u-table-header-1">
                    <tr style="height: 21px;">
                      <th class="u-border-1 u-border-black u-table-cell">name of drug </th>
                      <th class="u-border-1 u-border-black u-table-cell">the name of company  </th>
				  ...
				  if(isset($_POST['search'])){
					  $query = "SELECT `drug_id`, `drug_name`, `unit`, `package`, `quantity`, `date_of_purchace`, `company`, `expired_date` FROM `drugs` where drug_name like '%{$_POST['search']}%'";
				  }
				  else{
					  $query = "SELECT `drug_id`, `drug_name`, `unit`, `package`, `quantity`, `date_of_purchace`, `company`, `expired_date` FROM `drugs`";
				  }
				  ...
				  ?>
                    <tr style="height: 75px;">
                      <td class="u-border-1 u-border-grey-30 u-table-cell"><?php echo $row['drug_name'];?></td>
                      <td class="u-border-1 u-border-grey-30 u-table-cell"><?php echo $row['company'];?></td>
                      <td class="u-border-1 u-border-grey-30 u-table-cell"><?php echo $row['expired_date'];?></td>
                      <td class="u-border-1 u-border-grey-30 u-table-cell"><?php echo $row['quantity'];?></td>
                    </tr>
				  <?php } ?>
              ...
              <div class="u-align-center-sm u-align-right-md u-container-style u-layout-cell u-size-20 u-size-20-md u-layout-cell-2">
                <div class="u-container-layout u-container-layout-2">
                  <a href="https://nicepage.com" class="u-image u-image-round u-logo u-radius-2 u-image-1" data-image-width="596" data-image-height="204">
                    <img src="images/SUBCURE-02.png" class="u-logo-image u-logo-image-1" />
                  </a>
                </div>
              </div>
